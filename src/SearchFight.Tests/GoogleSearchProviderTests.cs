...
namespace SearchFight.Tests
{
    public class GoogleSearchProviderTests
    {
        ...
        //    var loggerMock = new Mock<ILogger<GoogleSearchProvider>>();
        //    var htmlParser = new Mock<IHtmlParser>();
        //    //htmlParser.SetReturnsDefault(new DataSearcherException());
        //    var expectedResult = 123;

        //    htmlParser.Setup(x => x.IndexOfTag(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>())).Returns(0);
        //    htmlParser.Setup(x => x.AfterIndexOfTag(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<int>())).Returns(0);
        //    htmlParser.Setup(x => x.ExtractNumber(It.IsAny<string>())).Returns(expectedResult);

        //    var httpClientFactoryMock = new Mock<IHttpClientFactory>();
        //    httpClientFactoryMock.SetupHttpClientResponse(KnownHttpClients.Google);
        ...
        //[Test]
        //public async Task NotOkResult()
        //{
        //    var loggerMock = new Mock<ILogger<GoogleSearchProvider>>();
        //    var htmlParser = new Mock<IHtmlParser>();

        //    var httpClientFactoryMock = new Mock<IHttpClientFactory>();
        //    httpClientFactoryMock.SetupHttpClientResponse(KnownHttpClients.Google, statusCode: HttpStatusCode.BadRequest);
        ...
        //    var httpClientFactoryMock = new Mock<IHttpClientFactory>();
        //    httpClientFactoryMock.SetupHttpClientResponse(KnownHttpClients.Google, stringContent: $"<div id=\"result-stats\">asdfkjh 12,.33-12%%%3+43 kuasdifu<nobr>");
        ...
        //[Test]
        //public async Task WrongNumberResult()
        //{
        //    var loggerMock = new Mock<ILogger<GoogleSearchProvider>>();
        //    var htmlParser = new Mock<IHtmlParser>();

        //    var httpClientFactoryMock = new Mock<IHttpClientFactory>();
        //    httpClientFactoryMock.SetupHttpClientResponse(KnownHttpClients.Google, stringContent: $"<div id=\"result-stats\">asdfkjh 12,.33-12%%%3+434654644121313 kuasdifu<nobr>");
        ...
        //[Test]
        //public async Task UnexpectedExceptionResult()
        //{
        //    var loggerMock = new Mock<ILogger<GoogleSearchProvider>>();
        //    var htmlParser = new Mock<IHtmlParser>();

        //    var httpClientFactoryMock = new Mock<IHttpClientFactory>();
        //    httpClientFactoryMock.Setup(x => x.CreateClient(It.IsAny<string>())).Throws<Exception>();
